...
5. 从 high-level 和 low-level 两个层次同时去考虑，优先选择投入产出比高的优化点
6. 熟练掌握并使用场景的 性能指标工具 和 性能 Profile 工具
7. 多和他人交流，同样的信息和上下文，每个人的关注点和解读的视角都有可能不同，有可能他人的一句话就会给自己带来启发，打破自己之前的思维定式
8. 熟能生巧，平常多搞一些性能优化的工作
